...
namespace Cirlmcesc\LaravelGeevalidate\Geesdk;
...
class GeetestLib
{
    ...
    const GEETEST_CHALLENGE = "geevalidate_challenge"; // 极验二次验证表单传参字段 chllenge
    const GEETEST_VALIDATE = "geevalidate_validate"; // 极验二次验证表单传参字段 validate
    const GEETEST_SECCODE = "geevalidate_seccode"; // 极验二次验证表单传参字段 seccode
    const GEETEST_SERVER_STATUS_SESSION_KEY = "geevalidate_server_status"; // 极验验证API服务状态Session Key
